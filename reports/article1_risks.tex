...
\Title{Estimating Disease-Free Life Expectancy based on Clinical Data
from the French Hospital Discharge Database}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Estimating Disease-Free Life Expectancy based on Clinical
Data from the French Hospital Discharge Database}
...
\Author{Oleksandr
Sorochynskyi$^{1,3,*}$\href{https://orcid.org/0009-0002-7511-7230}
{\orcidicon}, Quentin
Guibert$^{2}$\href{https://orcid.org/0000-0002-4915-2422}
{\orcidicon}, Frédéric
Planchet$^{1,3}$\href{https://orcid.org/0000-0003-4170-8016}
{\orcidicon}, Michaël
Schwarzinger$^{4,5}$\href{https://orcid.org/0000-0002-0573-6856}
{\orcidicon}}
...
\AuthorNames{Oleksandr Sorochynskyi, Quentin Guibert, Frédéric
Planchet, Michaël Schwarzinger}

% MDPI internal command: Authors, for citation in the left column
%\AuthorCitation{Lastname, F.; Lastname, F.; Lastname, F.}
% If this is a Chicago style journal: Lastname, Firstname, Firstname Lastname, and Firstname Lastname.
\AuthorCitation{Sorochynskyi, O.; Guibert Q. ; Planchet, F.;
Schwarzinger M.}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad ISFA---SAF Laboratory, Institut de Science Financière et
d'Assurances (ISFA), Laboratoire SAF EA2429, University Lyon, Université
Claude Bernard Lyon 1, F-69366 Lyon, France; \\
$^{2}$ \quad CEREMADE, Université Paris-Dauphine, PSL University, CNRS,
75016 Paris, France; \\
$^{3}$ \quad Prim'Act Actuarial consulting firm, 42 avenue de la Grande
Armée, F-75017 Paris, France; \\
$^{4}$ \quad Department of Prevention, Bordeaux University Hospital,
33000 Bordeaux, France; \\
$^{5}$ \quad University of Bordeaux, INSERM, BPH, U1219, I-prev/PHARES,
certified team under Ligue Contre le Cancer, CIC 1401, 33000 Bordeaux,
France; \\
}

% Contact information of the corresponding author
\corres{Correspondence: \href{mailto:oleksandr.sorochynskyi@primact.fr}{\nolinkurl{oleksandr.sorochynskyi@primact.fr}}}
...
\abstract{The development of health indicators to measure healthy life
expectancy (HLE) is an active field of research aimed at summarizing the
health of a population. Although many health indicators have emerged in
the literature as critical metrics in public health assessments, the
methods and data to conduct this evaluation vary considerably in nature
and quality. Traditionally, health data collection relies on population
...
% Keywords
\keyword{health indicators; Healthy life expectancy; HLE;
...
dataset \citep{guibert_mesure_2018, schwarzinger_etude_2018}. These
previous works define disability much more narrowly, considering only
two events, ``Physical dependence'' and ``Severe dementia''. Physical
dependence is defined as bedridden state.
\citet{schwarzinger_etude_2018} established that this definition of
disability aligns with severe disability as measured by activities of
daily living (ADLs). In our study, we aim to broaden our definition of
disability to encompass all identified severe events, bringing it closer
to a less severe level of activity limitation, similar to the concept of
Global Activity Limitation Instrument (GALI), the measure of disability
used for HLY.
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-20-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\begin{figure}
\centering
\includegraphics{article1_risks_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\acknowledgments{The authors are grateful to Christian Robert
(ISFA---SAF Laboratory) for providing guidance on writing of this
manuscript.}
