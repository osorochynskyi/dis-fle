...
#     department: Institut de Science Financière et d'Assurances (ISFA) 
#     affiliation: Université Claude Bernard Lyon 1
#     adress: 69366 Lyon, France
#     email : oleksandr.sorochynskyi@primact.fr
#   - name: Quentin Guibert
#     department: CEREMADE, Université Paris-Dauphine,
#     affiliation: PSL University, CNRS
#     adress: 75016 Paris, France
#   - name: Frédéric Planchet
#     department: Institut de Science Financière et d'Assurances (ISFA) 
#     affiliation: Université Claude Bernard Lyon 1
#   - name: Michaël Schwarzinger
#     department: Department of Prevention
#     affiliation: Bordeaux University Hospital
#     adress: 33000 Bordeaux, France
# authors:
#   - name: Oleksandr Sorochynskyi
#     affiliation: 1
...
population health [@world_health_organization_world_2023;@bogaert_use_2018]. Another example is
Japan, which has prioritized health as a key policy objective in recent years
[@abe_japans_2013].

Despite the consensus on the importance of health indicators, no universally
used definition of health emerged (Chapter 1, @jagger_international_2020).
...
(Chapter 5, @jagger_international_2020). Unlike mortality data, that are
...
(Chapter 1, @jagger_international_2020). In clinical settings, the focus is
...
life expectancies at 60 by sex and by department [@insee_esperances_2023].
Overall, we observe similar trends. The similarity suggests that the geographic
...
the dataset. Translated and adapted from Table 1 in @schwarzinger_etude_2018.
